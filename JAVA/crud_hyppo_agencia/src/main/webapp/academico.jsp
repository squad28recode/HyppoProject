    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link " href="atv.jsp">Atividades Extracurriculares</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="academico.jsp">Acadêmico</a>
          </li>
      ...
      <div class="col-sm-6 mb-3">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eos atque eligendi
              repudiandae at ipsam ipsum harum quae numquam. Odio, similique fuga veniam et reprehenderit hic blanditiis
              numquam eius possimus incidunt?</p>
            <a href="login.jsp" class="btn btn-dark">Ver mais</a>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam fuga repellendus soluta,
              similique dolorem quidem explicabo nulla itaque a et suscipit. Perferendis labore nam dolorem sint,
              commodi reiciendis praesentium excepturi!</p>
            <a href="login.jsp" class="btn btn-dark">Ver mais</a>
          </div>
        </div>
      </div>
