...
<body>
  ...
  <div class="container frm mb-5">
    ...
    <form>
      ...
      <div class="form-group m-3">
        <label for="validationDefault06" class="form-label">Digite o seu CPF</label>
        <input type="text" class="form-control" id="validationDefault06" placeholder="Digite o seu CPF" maxlength="11"
          required>
        <small id="emailHelp" class="form-text text-muted">Nunca vamos compartilhar seu CPF com ninguém.</small>
      </div>
      <div class="form-group m-3">
        <label for="exampleFormControlTextarea1">Descreva o seu problema ao suporte do nosso site abaixo: </label>
